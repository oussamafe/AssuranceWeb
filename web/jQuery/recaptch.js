(function () {
    ...
    var A = Array.prototype, Ma = A.indexOf ? function (a, b, c) {
            z(null != a.length);
            ...
            return -1
        }, Na = A.forEach ? function (a, b, c) {
            z(null != a.length);
            A.forEach.call(a, b, c)
        } : function (a, b, c) {
            for (var d = a.length, e = q(a) ? a.split("") : a, g = 0; g < d; g++) g in e && b.call(c, e[g], g, a)
        }, Oa = A.map ? function (a, b, c) {
            z(null != a.length);
            return A.map.call(a, b, c)
        } :
        function (a, b, c) {
            for (var d = a.length, e = Array(d), g = q(a) ? a.split("") : a, f = 0; f < d; f++) f in g && (e[f] = b.call(c, g[f], f, a));
            return e
        }, Pa = A.some ? function (a, b, c) {
            z(null != a.length);
            return A.some.call(a, b, c)
        } : function (a, b, c) {
            for (var d = a.length, e = q(a) ? a.split("") : a, g = 0; g < d; g++) if (g in e && b.call(c, e[g], g, a)) return !0;
            return !1
        }, Qa = function (a, b) {
            var c = Ma(a, b), d;
    ...
    var Ta = function (a, b) {
        ...
        Za = function (a, b) {
            for (var c, d, e = 1; e < arguments.length; e++) {
                d = arguments[e];
                for (c in d) a[c] = d[c];
                for (var g = 0; g < Ya.length; g++) c = Ya[g], Object.prototype.hasOwnProperty.call(d,
                    c) && (a[c] = d[c])
            }
        }, $a = function (a) {
            var b = arguments.length;
            if (1 == b && p(arguments[0])) return $a.apply(null, arguments[0]);
    ...
    ;var cb = -1 != B.indexOf("Opera") || -1 != B.indexOf("OPR"),
        C = -1 != B.indexOf("Trident") || -1 != B.indexOf("MSIE"),
        E = -1 != B.indexOf("Gecko") && -1 == B.toLowerCase().indexOf("webkit") && !(-1 != B.indexOf("Trident") || -1 != B.indexOf("MSIE")),
        F = -1 != B.toLowerCase().indexOf("webkit"), db = function () {
            var a = k.document;
            return a ? a.documentMode : void 0
        }, eb = function () {
            var a = "", b;
            if (cb && k.opera) return a = k.opera.version, r(a) ? a() : a;
            ...
            if (!(b = fb[a])) {
                ...
                for (var c = va(String(eb)).split("."), d = va(String(a)).split("."), e = Math.max(c.length, d.length), g = 0; 0 == b && g < e; g++) {
                    var f = c[g] || "", m = d[g] || "", D = RegExp("(\\d*)(\\D*)", "g"),
                        M = RegExp("(\\d*)(\\D*)", "g");
                    do {
                        var I = D.exec(f) || ["", "", ""], aa = M.exec(m) || ["", "", ""];
                        if (0 == I[0].length && 0 == aa[0].length) break;
                        b = Ea(0 == I[1].length ? 0 : parseInt(I[1], 10), 0 == aa[1].length ? 0 : parseInt(aa[1], 10)) || Ea(0 == I[2].length, 0 == aa[2].length) ||
                            Ea(I[2], aa[2])
                    } while (0 == b)
                }
                b = fb[a] = 0 <= b
            ...
            return b
        }, gb = k.document, hb = gb && C ? db() || ("CSS1Compat" == gb.compatMode ? parseInt(eb, 10) : 5) : void 0;
    var ib = function (a) {
        if (8192 > a.length) return String.fromCharCode.apply(null, a);
        for (var b = "", c = 0; c < a.length; c += 8192) var d = Sa(a, c, c + 8192), b = b + String.fromCharCode.apply(null, d);
        return b
    }, jb = function (a) {
    ...
    var kb = null, lb = null, mb = function (a) {
        if (!kb) {
            kb = {};
            lb = {};
            for (var b = 0; 65 > b; b++) kb[b] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(b), lb[kb[b]] = b, 62 <= b && (lb["ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_.".charAt(b)] = b)
        }
    ...
    var nb = function (a, b) {
        a.disposed_ ? b.call(void 0) : (a.onDisposeCallbacks_ || (a.onDisposeCallbacks_ = []), a.onDisposeCallbacks_.push(l(void 0) ? t(b, void 0) : b))
    };
    ...
    $a("embed", "iframe", "link", "object", "script", "style", "template");
    var pb = !C || C && 9 <= hb;
    !E && !C || C && C && 9 <= hb || E && G("1.9.1");
    C && G("9");
    var sb = function (a) {
    ...
    var Pb = function (a, b) {
        if (0 == a.state_) if (a.parent_) {
            var c = a.parent_;
            if (c.callbackEntries_) {
                for (var d = 0, e = -1, g = 0, f; f = c.callbackEntries_[g]; g++) if (f = f.child) if (d++, f == a && (e = g), 0 <= e && 1 < d) break;
                0 <= e && (0 == c.state_ && 1 == d ? Pb(c, b) : (d = c.callbackEntries_.splice(e, 1)[0], Qb(c, d, 3, b)))
            }
        } else J(a, 3, b)
    }, Sb = function (a, b) {
    ...
    L.prototype.executeCallbacks_ = function () {
        for (; this.callbackEntries_ && this.callbackEntries_.length;) {
            ...
            for (var b = 0; b < a.length; b++) Qb(this, a[b], this.state_, this.result_)
        }
        this.executing_ = !1
    };
    var Qb = function (a, b, c, d) {
        if (2 == c) b.onFulfilled(d); else {
            if (b.child) for (; a && a.hadUnhandledRejection_; a = a.parent_) a.hadUnhandledRejection_ = !1;
            b.onRejected(d)
        }
    }, Ub = function (a, b) {
...
*/
    ...
    N.prototype.cancel = function (a) {
        if (this.fired_) this.result_ instanceof N && this.result_.cancel(); else {
            if (this.parent_) {
                var b = this.parent_;
                delete this.parent_;
    ...
    N.prototype.continue_ = function (a, b) {
        this.blocked_ = !1;
        Yb(this, a, b)
    };
    var Yb = function (a, b, c) {
        ...
        if (a.fired_) {
            if (!a.silentlyCanceled_) throw new $b;
            a.silentlyCanceled_ = !1
        }
    };
    N.prototype.callback = function (a) {
        ac(this);
        bc(a);
        Yb(this, !0, a)
    };
    var Wb = function (a, b) {
        ...
        z(!a.blocking_, "Blocking Deferreds can not be re-used");
    ...
    var dc = function (a) {
        ...
        for (var b = a.result_, d = c = !1; a.sequence_.length && !a.blocked_;) {
            ...
            if (g = a.hadError_ ? f : g) try {
                ...
                b = D, a.hadError_ = !0, dc(a) || (c = !0)
            }
        }
        a.result_ = b;
        d && (m = t(a.continue_, a, !0), d = t(a.continue_, a, !1), b instanceof N ? (cc(b, m, d), b.blocking_ = !0) : b.then(m, d));
    ...
    var fc = function (a) {
        this.id_ = k.setTimeout(t(this.throwError, this), 0);
        this.error_ = a
    };
    fc.prototype.throwError = function () {
        z(ec[this.id_], "Cannot throw an error that is not scheduled.");
        delete ec[this.id_];
        throw this.error_;
    };
    var ec = {};
    var kc = function (a) {
        var b = {}, c = b.document || document, d = document.createElement("SCRIPT"),
            e = {script_: d, timeout_: void 0}, g = new N(gc, e), f = null, m = null != b.timeout ? b.timeout : 5E3;
        ...
        vb(d, {type: "text/javascript", charset: "UTF-8", src: a});
        jc(c).appendChild(d);
        return g
    }, jc = function (a) {
    ...
    lc[" "] = ba;
    var mc = !C || C && 9 <= hb, nc = C && !G("9");
    !F || G("528");
    E && G("1.9b") || C && G("8") || cb && G("9.5") || F && G("528");
    E && !G("8") || C && G("9");
    var O = function (a, b) {
        this.type = a;
    ...
    var oc = function (a, b) {
        ...
        if (a) {
            ...
            Object.defineProperties ? Object.defineProperties(this, {
                ...
                }, offsetY: {configurable: !0, enumerable: !0, get: this.getOffsetY_, set: this.setOffsetY_}
            }) : (this.offsetX = this.getOffsetX_(), this.offsetY = this.getOffsetY_());
    ...
    h.preventDefault = function () {
        oc.superClass_.preventDefault.call(this);
        var a = this.event_;
        if (a.preventDefault) a.preventDefault(); else if (a.returnValue = !1, nc) try {
    ...
    h.getOffsetX_ = function () {
        return F || void 0 !== this.event_.offsetX ? this.event_.offsetX : this.event_.layerX
    };
    h.setOffsetX_ = function (a) {
        Object.defineProperties(this, {offsetX: {writable: !0, enumerable: !0, configurable: !0, value: a}})
    };
    h.getOffsetY_ = function () {
        return F || void 0 !== this.event_.offsetY ? this.event_.offsetY : this.event_.layerY
    };
    h.setOffsetY_ = function (a) {
        Object.defineProperties(this, {offsetY: {writable: !0, enumerable: !0, configurable: !0, value: a}})
    };
    var pc = "closure_listenable_" + (1E6 * Math.random() | 0), qc = 0;
    ...
    P.prototype.add = function (a, b, c, d, e) {
        ...
        var f = tc(a, b, d, e);
        -1 < f ? (b = a[f], c || (b.callOnce = !1)) : (b = new rc(b, this.src, g, !!d, e), b.callOnce = c, a.push(b));
        return b
    };
    P.prototype.remove = function (a, b, c, d) {
        ...
        b = tc(e, b, c, d);
        return -1 < b ? (sc(e[b]), z(null != e.length), A.splice.call(e, b, 1), 0 == e.length && (delete this.listeners[a], this.typeCount_--), !0) : !1
    };
    var uc = function (a, b) {
        var c = b.type;
    ...
    var vc = "closure_lm_" + (1E6 * Math.random() | 0), wc = {}, xc = 0, yc = function (a, b, c, d, e) {
        ...
        c = zc(c);
        if (a && a[pc]) a = a.listen(b, c, d, e); else {
        ...
        if (p(b)) for (var g = 0; g < b.length; g++) Ec(a, b[g], c, d, e); else c = zc(c), a && a[pc] ? a.unlisten(b, c, d, e) : a && (a = Ac(a)) && (b = a.getListener(b, c, !!d, e)) && Fc(b)
    }, Fc = function (a) {
        if ("number" == typeof a || !a || a.removed) return !1;
        var b = a.src;
        if (b && b[pc]) return uc(b.eventTargetListeners_, a);
        ...
        var e = !0;
        if (a = Ac(a)) if (b = a.listeners[b.toString()]) for (b = b.concat(), a = 0; a < b.length; a++) {
            var g = b[a];
            g && g.capture == c && !g.removed && (g = Gc(g, d), e = e && !1 !== g)
        }
        return e
    }, Gc = function (a, b) {
        ...
        if (!mc) {
            ...
            if (!(c = b)) t:{
                c = ["window", "event"];
                for (var d = k, e; e = c.shift();) if (null !=
                    d[e]) d = d[e]; else {
                    c = null;
                    break t
                }
            ...
            if (!(0 > e.keyCode || void 0 != e.returnValue)) {
                ...
                for (var g = a.type, m = e.length - 1; !c.propagationStopped_ && 0 <= m; m--) {
                    c.currentTarget = e[m];
                    var D = Hc(e[m], g, !0, c), d = d && D
                }
                for (m = 0; !c.propagationStopped_ && m < e.length; m++) c.currentTarget = e[m], D = Hc(e[m], g, !1, c), d = d && D
            }
            return d
        }
    ...
    }, Ic = "__closure_events_fn_" + (1E9 * Math.random() >>> 0), zc = function (a) {
    ...
    h.unlisten = function (a, b, c, d, e) {
        if (p(b)) for (var g = 0; g < b.length; g++) this.unlisten(a, b[g], c, d, e); else c = c || this.handleEvent, e = e || this.handler_ || this, c = zc(c), d = !!d, b = a && a[pc] ? a.getListener(b, c, d, e) : a ? (a = Ac(a)) ? a.getListener(b, c, d, e) : null : null, b && (Fc(b), delete this.keys_[b.key]);
        return this
    };
    ...
    h.dispatchEvent = function (a) {
        ...
        if (c) {
            b = [];
            for (var d = 1; c; c = c.parentEventTarget_) b.push(c), z(1E3 > ++d, "infinite loop")
        }
        c = this.actualEventTarget_;
        d = a.type || a;
        if (q(a)) a = new O(a, c); else if (a instanceof O) a.target = a.target || c; else {
            var e = a;
            a = new O(d, c);
            Za(a, e)
        }
        var e = !0, g;
        if (b) for (var f = b.length - 1; !a.propagationStopped_ && 0 <= f; f--) g = a.currentTarget = b[f], e = Lc(g, d, !0, a) && e;
        a.propagationStopped_ || (g = a.currentTarget = c, e = Lc(g, d, !0, a) && e, a.propagationStopped_ || (e = Lc(g, d, !1, a) &&
            e));
        if (b) for (f = 0; !a.propagationStopped_ && f < b.length; f++) g = a.currentTarget = b[f], e = Lc(g, d, !1, a) && e;
        return e
    };
    h.disposeInternal = function () {
    ...
    var Lc = function (a, b, c, d) {
        ...
        for (var e = !0, g = 0; g < b.length; ++g) {
            ...
            if (f && !f.removed && f.capture == c) {
                var m = f.listener, D = f.handler || f.src;
    ...
    var Kc = function (a) {
        z(a.eventTargetListeners_, "Event target is not initialized. Did you call the superclass (goog.events.EventTarget) constructor?")
    };
    var S = function (a) {
        R.call(this);
    ...
    v(S, R);
    var Mc = [C && !G("11") ? "readystatechange" : "load", "abort", "error"], Nc = function (a, b, c) {
        (c = q(c) ? c : c.src) && (a.imageIdToRequestMap_[b] = {src: c, corsRequestType: l(void 0) ? void 0 : null})
    };
    ...
    var Qc = function (a, b) {
        ...
        a.parent_ && !a.parent_.inDocument_ || Pc(a)
    }, Pc = function (a) {
        a.inDocument_ = !0;
        Rc(a, function (a) {
            !a.inDocument_ && a.getElement() && Pc(a)
        })
    }, Sc = function (a) {
        Rc(a, function (a) {
            a.inDocument_ && Sc(a)
    ...
    U.prototype.removeChild = function (a, b) {
        if (a) {
            ...
            if (c && a) {
                ...
                c in d && delete d[c];
                Qa(this.children_, a);
                b && (Sc(a), a.element_ && Bb(a.element_));
                c = a;
    ...
    var Tc = function (a) {
        ...
        if (!(c = c || (a.currentStyle ? a.currentStyle[b] : null)) && (c = a.style[Fa(b)], "undefined" === typeof c)) {
            ...
            if (!d) {
                var e = Fa(b), d = e;
                void 0 === a.style[e] && (e = (F ? "Webkit" : E ? "Moz" : C ? "ms" : cb ? "O" : null) + Ga(e), void 0 !== a.style[e] && (d =
                    e));
                Oc[b] = d
            }
            c = c[d] || ""
    ...
    h.start = function (a) {
        ...
        if (!r(b)) if (b && "function" == typeof b.handleEvent) b = t(b.handleEvent, b); else throw Error("Invalid listener argument");
    ...
    var Wc = function (a, b) {
        ...
        this.listener_ = a;
        this.handler_ = b;
        this.delay_ = new Vc(t(this.onTick_, this), 0, this)
    };
    v(Wc, H);
    h = Wc.prototype;
    h.interval_ = 0;
    ...
    h.disposeInternal = function () {
        ...
        delete this.listener_;
        delete this.handler_;
        Wc.superClass_.disposeInternal.call(this)
    };
    ...
    h.onTick_ = function () {
        if (this.listener_.call(this.handler_)) this.onSuccess(); else if (0 > this.runUntil_) this.delay_.start(this.interval_); else {
            var a = this.runUntil_ - ha();
            if (0 >= a) this.onFailure(); else this.delay_.start(Math.min(this.interval_, a))
        }
    };
    var Xc = {sanitizedContentKindHtml: !0}, Yc = {sanitizedContentKindText: !0}, Zc = function () {
        throw Error("Do not instantiate directly");
    };
    Zc.prototype.contentDir = null;
    Zc.prototype.toString = function () {
        return this.content
    };
    var dd = function (a) {
        var b = $c;
        z(b, "Soy template may not be null.");
        var c = sb().createElement("DIV");
        a = ad(b(a || bd, void 0, void 0));
        b = a.match(cd);
        ...
        return "zSoyz"
    }, cd = /^<(body|caption|col|colgroup|head|html|tr|td|tbody|thead|tfoot)>/i, bd = {};
    C && G(8);
    var ed = function () {
        Zc.call(this)
    };
    ...
    var gd = {
        ...
        return gd[a]
    }, id = /[\x00\x08-\x0d\x22\x26\x27\/\x3c-\x3e\\\x85\u2028\u2029]/g;
    var $c = function (a) {
        return fd('<script type="text/javascript">var challenge = \'' + String(a.challenge).replace(id, hd) + "'; var publisherId = '" + String(a.publisherId).replace(id, hd) + "';" + ("ca-mongoogle" == a.publisherId ? 'google_page_url = "3pcerttesting.com/dab/recaptcha.html";' : "") + "\n    google_ad_client = publisherId;\n    google_ad_type = 'html';\n    google_ad_output = 'js';\n    google_image_size = '300x57';\n    google_captcha_token = challenge;\n    google_ad_request_done = function(ad) {\n      window.parent.recaptcha.ads.adutils.googleAdRequestDone(ad);\n    };\n    \x3c/script><script type=\"text/javascript\" src=\"//pagead2.googlesyndication.com/pagead/show_ads.js\">\x3c/script>")
    };
    $c.soyTemplateName = "recaptcha.soy.ads.iframeAdsLoader.main";
    var Wa = function () {
        var a = k.google_ad;
        ...
        var b = new S;
        Nc(b, "recaptcha-url-" + ld++, a);
        b.start()
    }, nd = function (a, b) {
        var c =
            RecaptchaState.publisher_id;
        jd();
        var d = xb("iframe", {id: "recaptcha-loader-" + ld++, style: "display: none"});
        document.body.appendChild(d);
        var e = d.contentWindow ? d.contentWindow.document : d.contentDocument;
        e.open("text/html", "replace");
        e.write(dd({challenge: a, publisherId: c}).innerHTML);
        e.close();
        c = new Wc(function () {
            return !!k.google_ad
        });
    ...
    u("recaptcha.ads.adutils.googleAdRequestDone", function (a) {
        k.google_ad = a
    });
    var od = function () {
        this.blockSize = -1
    ...
    var qd = function (a, b, c) {
        c || (c = 0);
        var d = Array(16);
        if (q(b)) for (var e = 0; 16 > e; ++e) d[e] = b.charCodeAt(c++) | b.charCodeAt(c++) << 8 | b.charCodeAt(c++) << 16 | b.charCodeAt(c++) << 24; else for (e = 0; 16 > e; ++e) d[e] = b[c++] | b[c++] << 8 | b[c++] << 16 | b[c++] << 24;
        b = a.chain_[0];
        c = a.chain_[1];
    ...
    pd.prototype.update = function (a, b) {
        ...
        for (var c = b - this.blockSize, d = this.block_, e = this.blockLength_, g = 0; g < b;) {
            if (0 == e) for (; g <= c;) qd(this, a, g), g += this.blockSize;
            if (q(a)) for (; g < b;) {
            ...
            } else for (; g < b;) if (d[e++] = a[g++], e == this.blockSize) {
                qd(this, d);
                e = 0;
                break
            }
    ...
    var rd = function (a, b, c, d, e) {
        ...
        a.element_ = b;
        a.callback_ = e;
        a.listen(b, "keyup", t(a.onChanged_, a, c, d))
    };
    ...
    X.prototype.onChanged_ = function (a, b) {
        ...
        c.update(d);
        d = Array(16);
        for (e = g = 0; 4 > e; ++e) for (var f = 0; 32 > f; f += 8) d[g++] = c.chain_[e] >>> f & 255;
    ...
    var sd = function (a) {
        ...
        var c = {};
        yc(b, "load", t(function (a, b) {
            a[b.target.id] = b.target
        }, a, c));
        yc(b, "complete", t(a.handleImagesLoaded_, a, c));
        b.start()
    };
    td.prototype.handleImagesLoaded_ = function (a) {
        a = new V(a.recaptcha_challenge_image, a.recaptcha_ad_image);
        nb(this, ga(ob, a));
        var b = tb(document, "recaptcha_image");
        Ab(b);
        Qc(a, b);
        a.adImage_ && Tc(a.adImage_) && (md(this.adObject_.delayedImpressionUrl), a = new X, nb(this, ga(ob, a)), rd(a, tb(document, "recaptcha_response_field"), this.adObject_.hashedAnswer, this.adObject_.salt, t(function (a, b) {
            a.unwatch();
            md(b)
    ...
    var Z = {
        ...
        _get_overridable_url: function (a) {
            ...
            if ("undefined" != typeof _RecaptchaOverrideApiServer) a = _RecaptchaOverrideApiServer; else if ("undefined" != typeof RecaptchaState && "string" == typeof RecaptchaState.server &&
        ...
        _init_builtin_theme: function () {
            var a = Z.$, b = Z._get_static_url_root(), c = w.VertCss, d = w.VertHtml, e = b + "/img/" + Z.theme,
                g = "gif", b = Z.theme;
            "clean" == b && (c = w.CleanCss, d = w.CleanHtml, g = "png");
        ...
        _finish_widget: function () {
            ...
            c in {blackglass: 1, clean: 1, custom: 1, red: 1, white: 1} || (c = "red");
            Z.theme || (Z.theme = c);
        ...
        _set_challenge: function (a, b, c) {
            "image" == b && RecaptchaState.publisher_id ? nd(a, function () {
        ...
        _set_challenge_internal: function (a, b, c) {
            ...
            c || ("audio" == b ? (d("recaptcha_image").innerHTML = Z.getAudioCaptchaHtml(), Z._loop_playback()) : "image" == b && (a = e.payload_url, a || (a = Z._get_api_server() + "/image?c=" + e.challenge, Z.th_callback_invoke(), Z.th1 && (a += "&th=" + Z.th1, Z.th1 = "")), kd(d("recaptcha_widget_div")), Wa() ? Z.ad_captcha_plugin = new td(Xa(), a, function (a) {
                ...
                W.image_alt_text + '" height="57" width="300" src="' + a + '" />', jd()));
        ...
        _css_toggle: function (a, b, c) {
            ...
            d ||
            (d = document.body);
            var e = d.className, e = e.replace(new RegExp("(^|\\s+)" + a + "(\\s+|$)"), " "),
        ...
        getAudioCaptchaHtml: function () {
            ...
            var b = Z._get_api_server() + "/swf/audiocaptcha.swf?v2",
                b = Z._is_ie() ? '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" id="audiocaptcha" width="0" height="0" codebase="https://fpdownload.macromedia.com/get/flashplayer/current/swflash.cab"><param name="movie" value="' + b + '" /><param name="quality" value="high" /><param name="bgcolor" value="#869ca7" /><param name="allowScriptAccess" value="always" /></object><br/>' :
                    '<embed src="' + b + '" quality="high" bgcolor="#869ca7" width="0" height="0" name="audiocaptcha" align="middle" play="true" loop="false" quality="high" allowScriptAccess="always" type="application/x-shockwave-flash" pluginspage="http://www.adobe.com/go/getflashplayer" /></embed>',
                c = "";
        ...
        challenge_callback: function () {
            ...
            if (RecaptchaState.t3) {
                var a = RecaptchaState.t1 ? ib(mb(RecaptchaState.t1)) : "",
                    b = RecaptchaState.t2 ? ib(mb(RecaptchaState.t2)) : "",
                    c = RecaptchaState.t3 ? ib(mb(RecaptchaState.t3)) : "";
                Z.th2 = c;
                if (a) b = kc(a), cc(b, Z.challenge_callback_internal, null, void 0), cc(b, null, Z.challenge_callback_internal, void 0); else {
                    if (k.execScript) k.execScript(b, "JavaScript"); else if (k.eval) null == ia && (k.eval("var _et_ = 1;"),
                        "undefined" != typeof k._et_ ? (delete k._et_, ia = !0) : ia = !1), ia ? k.eval(b) : (a = k.document, c = a.createElement("script"), c.type = "text/javascript", c.defer = !1, c.appendChild(a.createTextNode(b)), a.body.appendChild(c), a.body.removeChild(c)); else throw Error("goog.globalEval not available");
